...
import Controllers.GameScences.GameOverGameScence;
...
//                bulletManager.add(bulletController);
    ...
    public void onCollide(Colliable colliable) {
        if(colliable instanceof EnemyController) {
            ...
            gameSceneListener.changeGameScene(new GameOverGameScence());
        }
        if(colliable instanceof EnemyBulletControllerManager){
            colliable.getGameObject().destroy();
            gameSceneListener.changeGameScene(new GameOverGameScence());
        }
    }
